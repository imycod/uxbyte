      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-muted-foreground mb-4">
            我们致力于为您提供最优质的商品和最便捷的购物体验。精选全球好物，品质保证，快速配送。
          </p>
        ...
        <!-- 快捷链接 -->
        <div>
          <h3 class="text-lg font-semibold text-foreground mb-4">快捷链接</h3>
          <ul class="space-y-2">
        ...
        <!-- 联系方式 -->
        <div>
          <h3 class="text-lg font-semibold text-foreground mb-4">联系方式</h3>
          <ul class="space-y-2 text-muted-foreground">
            <li class="flex items-start">
              <svg class="h-5 w-5 mr-2 mt-0.5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
